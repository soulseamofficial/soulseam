  ...
  const SoulSeamEcommerce = () => {
    ...
    return (
      <div className="min-h-screen bg-black text-white">
        ...
        <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 lg:px-8 bg-black text-white">
    <div className="max-w-7xl mx-auto">
...
<div className="feature-icon w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 rounded-full border border-white/70 flex items-center justify-center bg-black">
            🌱
          </div>
